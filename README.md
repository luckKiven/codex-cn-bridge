...
```bash
# 下载 ZIP
curl -L https://github.com/luckKiven/codex-cn-bridge/archive/refs/heads/main.zip -o codex-cn-bridge.zip

# 解压
Expand-Archive codex-cn-bridge.zip -DestinationPath ~/.openclaw/workspace/skills/
```
